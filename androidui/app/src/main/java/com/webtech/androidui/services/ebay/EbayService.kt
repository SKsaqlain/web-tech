...
private val serverUrl = "http://10.0.2.2:8080"
    ...
    fun findAllItems(
        ...
        val url =
            "$serverUrl/ebay/findAllItems?trackingId=$trackingId&keywords=$keyword&category=$catId&condition=$condArray&shipping=$shipArray&distance=$distance&postalCode=$postalCode"
